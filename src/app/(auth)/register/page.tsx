...
function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // validate data
        // if any of the field is missing, set the error
      ...
      // if there is any error during creating account set error or else login the user
        if(response.error){
  ...
  return (
    ...
    <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
        Signup with CodeXchange if you you don&apos;t have an account.
